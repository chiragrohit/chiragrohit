...
<div class="flex flex-col md:flex-row bg-gray-300 dark:bg-gray-800 p-4 max-w-screen-lg mx-auto">
		...
		<div class="flex mt-2">
			<div class="flex flex-col space-y-2">
				<a
					...
					target="_blank"
					class="flex space-x-2 p-2 hover:bg-gray-800 dark:hover:bg-gray-700 hover:text-white"
				>
					<Github />
